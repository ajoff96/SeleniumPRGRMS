...
public class AmazonDemo {
	...
	public void AddAddress() throws InterruptedException {
		...
		d.findElement(By.cssSelector("#a-page > div.a-container > div > div:nth-child(3) > div:nth-child(1) > a"))
				.click();// Your Address click
		Thread.sleep(3000);
	...
	@Test(priority = 2)
	public void Airpods() throws InterruptedException {
...

	{
		...
		d.findElement(By.xpath("//*[@id=\"address-list\"]/div/div[1]/div/fieldset[2]/div[2]/span/div/label/input"))
				.click();// Select address To Checkout
		Thread.sleep(2000);
